...
require 'serverspec/matchers/be_expireable'
require 'serverspec/matchers/be_expired'
require 'serverspec/matchers/be_reg_key'
require 'serverspec/matchers/have_reg_value'